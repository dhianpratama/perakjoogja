...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/nav-header/nav-header.component.html',
    '<div class="navbar" style="background: #3d3734;">\n' +
    ...
    '    </div>\n' +
    '    <div class="logo-box">\n' +
    '      <a class="logo-text" style="color: whitesmoke;"><span>PerakJoogja</span></a>\n' +
    '    </div>\n' +
    '    <!-- Logo Box -->\n' +
    '    <div class="search-button">\n' +
    '      <a href="javascript:void(0);" class="waves-effect waves-button waves-classic show-search"><i class="fa fa-search"></i></a>\n' +
    '    </div>\n' +
    '    <div class="topmenu-outer" style="background:transparent !important;">\n' +
    '      <div class="top-menu">\n' +
    '        <ul class="nav navbar-nav navbar-right">\n' +
    '          <li class="dropdown">\n' +
    '            <a class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown" style="color: whitesmoke;">\n' +
    '              <span class="user-name">Guest<i class="fa fa-angle-down"></i></span>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/nav-sidebar/nav-sidebar.component.html',
    ...
    '      <li><a ui-sref="app.order-form"><i class="fa fa-dashboard"></i>&nbsp;<p>Order Baru</p></a></li>\n' +
    '      <li><a ui-sref="app.master-product"><i class="fa fa-gift"></i>&nbsp;<p>Data Product</p></a></li>\n' +
    '      \n' +
    '    </ul>\n' +
    '  </div>\n' +
    '  <!-- Page Sidebar Inner -->\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/order-form/order-form.component.html',
    ...
    '              </uib-tab-heading>\n' +
    '              <form class="form-horizontal" name="personalInfoForm" ng-submit="vm.save(personalInfoForm.$valid)" novalidate>\n' +
    '                <div class="box-body">\n' +
    '                  <div class="form-group" ng-class="{ \'has-error\': personalInfoForm.username.$invalid && ( vm.formSubmitted || personalInfoForm.username.$touched) }">\n' +
    '                    <label for="inputEmail3" class="col-sm-2 control-label">Username</label>\n' +
    '                    <div class="col-sm-10">\n' +
    '                      <input type="text" class="form-control" ng-model="vm.data.username" name="name" required>\n' +
    '                      <p ng-show="personalInfoForm.username.$error.required && ( vm.formSubmitted || personalInfoForm.username.$touched)" class="help-block">Username wajid diisi.</p>\n' +
    '                    </div>\n' +
    '                  </div>\n' +
    '                  <div class="form-group" ng-class="{ \'has-error\': personalInfoForm.email.$invalid && ( vm.formSubmitted || personalInfoForm.email.$touched) }">\n' +
    '                    <label for="inputEmail3" class="col-sm-2 control-label">Email</label>\n' +
    '                    <div class="col-sm-10">\n' +
    '                      <input type="text" class="form-control" ng-model="vm.data.email" name="name" required>\n' +
    '                      <p ng-show="personalInfoForm.email.$error.required && ( vm.formSubmitted || personalInfoForm.email.$touched)" class="help-block">Email wajid diisi.</p>\n' +
    '                    </div>\n' +
    '                  </div>\n' +
    '                  <div class="form-group" ng-class="{ \'has-error\': personalInfoForm.name.$invalid && ( vm.formSubmitted || personalInfoForm.name.$touched) }">\n' +
    '                    <label for="inputEmail3" class="col-sm-2 control-label">Nama Pemesan</label>\n' +
    '                    <div class="col-sm-10">\n' +
    '                      <input type="text" class="form-control" ng-model="vm.data.name" name="name" required>\n' +
    '                      <p ng-show="personalInfoForm.name.$error.required && ( vm.formSubmitted || personalInfoForm.name.$touched)" class="help-block">Nama wajid diisi.</p>\n' +
    '                    </div>\n' +
    '                  </div>\n' +
    '                  <div class="form-group" ng-class="{ \'has-error\': personalInfoForm.phone.$invalid && ( vm.formSubmitted || personalInfoForm.phone.$touched) }">\n' +
    '                    <label for="inputEmail3" class="col-sm-2 control-label">Telp</label>\n' +
    '                    <div class="col-sm-10">\n' +
    '                      <input type="text" class="form-control" ng-model="vm.data.phone" name="name" required>\n' +
    '                      <p ng-show="personalInfoForm.phone.$error.required && ( vm.formSubmitted || personalInfoForm.phone.$touched)" class="help-block">Telp wajid diisi.</p>\n' +
    '                    </div>\n' +
    '                  </div>\n' +
    '                  <div class="form-group">\n' +
    '                    <label for="inputEmail3" class="col-sm-2 control-label">Line</label>\n' +
    '                    <div class="col-sm-10">\n' +
    '                      <input type="text" class="form-control" ng-model="vm.data.line" name="name">\n' +
    '                    </div>\n' +
    '                  </div>\n' +
    '                  <div class="form-group">\n' +
    '                    <label for="inputEmail3" class="col-sm-2 control-label">BBM</label>\n' +
    '                    <div class="col-sm-10">\n' +
    '                      <input type="text" class="form-control" ng-model="vm.data.bbm" name="name">\n' +
    '                    </div>\n' +
    '                  </div>\n' +
    '                  <div class="form-group">\n' +
    '                    <label for="inputEmail3" class="col-sm-2 control-label">Instagram</label>\n' +
    '                    <div class="col-sm-10">\n' +
    '                      <input type="text" class="form-control" ng-model="vm.data.instagram" name="name">\n' +
    '                    </div>\n' +
    '                  </div>\n' +
    '                  <div class="form-group">\n' +
    '                    <label for="inputEmail3" class="col-sm-2 control-label">Agama</label>\n' +
    '                    <div class="col-sm-10">\n' +
    '                      <input type="text" class="form-control" ng-model="vm.data.religion" name="name">\n' +
    '                    </div>\n' +
    '                  </div>\n' +
    '                  <div class="form-group">\n' +
    '                    <label for="inputEmail3" class="col-sm-2 control-label">Alamat</label>\n' +
    '                    <div class="col-sm-10">\n' +
    '                      <input type="text" class="form-control" ng-model="vm.data.address" name="name">\n' +
    '                    </div>\n' +
    '                  </div>\n' +
    '                </div>\n' +
    '              </form>\n' +
    ...
    '\n' +
    '\n' +
    '            <!--Tab 2 : Detail Product-->\n' +
    '            <uib-tab index="1" heading="Detail Barang">\n' +
    '              <uib-tab-heading>\n' +
    '                <i class="fa fa-diamond"></i> Detail Barang\n' +
    '              </uib-tab-heading>\n' +
    '              <form class="form-horizontal" name="detailForm" ng-submit="vm.save(personalInfoForm.$valid)" novalidate>\n' +
    '                <div class="box-body">\n' +
    '                  <div class="form-group">\n' +
    '                    <label for="inputEmail3" class="col-sm-2 control-label">Kode Barang</label>\n' +
    '                    <div class="col-sm-10">\n' +
    '                      <angucomplete placeholder="Search Product" pause="100" selectedobject="vm.selectedProduct" localdata="vm.products" searchfields="code"\n' +
    '                        titlefield="code" minlength="1" inputclass="form-control form-control-small" />\n' +
    '                      <div>\n' +
    '                        <h4 ng-if="vm.selectedProduct!=null">Anda memesan : {{ vm.selectedProduct.originalObject.type }} - {{ vm.selectedProduct.originalObject.code\n' +
    '                          }}\n' +
    '                        </h4>\n' +
    '                      </div>\n' +
    '                    </div>\n' +
    '                  </div>\n' +
    '                  <div ng-if="vm.selectedProduct.originalObject.type===\'Cincin\'">\n' +
    '                    <div class="form-group">\n' +
    '                      <label for="inputEmail3" class="col-sm-2 control-label">Tipe Barang</label>\n' +
    '                      <div class="col-sm-10">\n' +
    '                        <select ng-options="t as t for t in vm.ringTypes" ng-model="vm.data.ringType" class="form-control" name="type" required>\n' +
    '                                <option value="">-- Pilih Tipe Cincin --</option>\n' +
    '                              </select>\n' +
    '                      </div>\n' +
    '                    </div>\n' +
    '                    <div class="form-group" ng-if="vm.data.ringType===\'Couple\' || vm.data.ringType===\'Single Pria\' ">\n' +
    '                      <label for="inputEmail3" class="col-sm-2 control-label">Bahan Pria</label>\n' +
    '                      <div class="col-sm-10">\n' +
    '                        <select ng-options="t as t for t in vm.materials" ng-model="vm.data.type" class="form-control" name="type" required>\n' +
    '                                <option value="">-- Pilih Bahan Pria --</option>\n' +
    '                              </select>\n' +
    '                      </div>\n' +
    '                    </div>\n' +
    '                    <div class="form-group" ng-if="vm.data.ringType===\'Couple\' || vm.data.ringType===\'Single Wanita\' ">\n' +
    '                      <label for="inputEmail3" class="col-sm-2 control-label">Bahan Wanita</label>\n' +
    '                      <div class="col-sm-10">\n' +
    '                        <select ng-options="t as t for t in vm.materials" ng-model="vm.data.type" class="form-control" name="type" required>\n' +
    '                                <option value="">-- Pilih Bahan Wanita --</option>\n' +
    '                              </select>\n' +
    '                      </div>\n' +
    '                    </div>\n' +
    '                  </div>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/pages/footer/footer.page.html',
    ...
    '    <b>Version</b> 1.0.0\n' +
    '  </div>\n' +
    '  <strong>Copyright &copy; 2016 <a href="http://almsaeedstudio.com">Young Creative Thinker</a>.</strong> All rights reserved.\n' +
    '</footer>\n' +
    '');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/pages/login/login.page.html',
    '<div class="login-box">\n' +
    '  <div class="login-logo">\n' +
    '    <a ui-sref="login"><b>YCT</b>&nbsp;admin</a>\n' +
    '  </div>\n' +
    '  <div class="login-box-body">\n' +
    '    <div class="row">\n' +
    '      <div class="col-xs-12">\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/category/category-form/category-form.component.html',
    ...
    '  <ol class="breadcrumb">\n' +
    '    <li><a ui-sref="app.landing"><i class="fa fa-dashboard"></i> Home</a></li>\n' +
    '    <li><a ui-sref="app.userlist">Category Lists</a></li>\n' +
    ...
    '        </div>\n' +
    '        <form class="form-horizontal" name="eventTypeForm" ng-submit="vm.save(eventTypeForm.$valid)" novalidate>\n' +
    '          <div class="box-body">\n' +
    '            <div ng-if="vm.alerts" class="alert alert-{{alert.type}}" ng-repeat="alert in vm.alerts">\n' +
    '              <h4>{{alert.title}}</h4>\n' +
    '              <p>{{alert.msg}}</p>\n' +
    '            </div>\n' +
    '            <div class="form-group" ng-class="{ \'has-error\': eventTypeForm.name.$invalid && ( vm.formSubmitted || eventTypeForm.name.$touched) }">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Name</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.name" name="name" placeholder="Name" required>\n' +
    '                <p ng-show="eventTypeForm.name.$error.required && ( vm.formSubmitted || eventTypeForm.name.$touched)" class="help-block">Name is required.</p>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group" ng-class="{ \'has-error\': eventTypeForm.description.$invalid && ( vm.formSubmitted || eventTypeForm.description.$touched) }">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Description</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.description" name="description" placeholder="Description" required>\n' +
    '                <p ng-show="eventTypeForm.description.$error.required && ( vm.formSubmitted || eventTypeForm.description.$touched)" class="help-block">Description is required.</p>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '          </div>\n' +
    '          <div class="box-footer">\n' +
    '            <a ui-sref="app.categorylist" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</a>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/event/event-form/event-form.component.html',
    '<section class="content-header">\n' +
    '  <h1>Event Type Form <small></small></h1>\n' +
    '  <ol class="breadcrumb">\n' +
    '    <li><a ui-sref="app.landing"><i class="fa fa-dashboard"></i> Home</a></li>\n' +
    '    <li><a ui-sref="app.userlist">Event Lists</a></li>\n' +
    '    <li class="active">Event Form</li>\n' +
    '  </ol>\n' +
    '</section>\n' +
    '<section class="content">\n' +
    '  <form class="form-horizontal" name="eventForm" ng-submit="vm.save(eventForm.$valid)" novalidate>\n' +
    '  <div class="row">\n' +
    ...
    '              <p>{{alert.msg}}</p>\n' +
    '            </div>\n' +
    '            <div class="form-group" ng-class="{ \'has-error\': eventForm.title.$invalid && ( vm.formSubmitted || eventForm.title.$touched) }">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Name</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.title" name="title" placeholder="Name" required>\n' +
    '                <p ng-show="eventForm.title.$error.required && ( vm.formSubmitted || eventForm.title.$touched)" class="help-block">Title is required.</p>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Caption</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.caption" name="caption" placeholder="Caption">\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group" ng-class="{ \'has-error\': eventForm.event_type_id.$invalid && ( vm.formSubmitted || eventForm.event_type_id.$touched) }">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Event Type</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <select ng-options="t.id as t.name for t in vm.eventTypes" ng-model="vm.data.event_type_id" class="form-control" name="event_type_id" required>\n' +
    '                  <!--<option value="">-- Select Event Type --</option>-->\n' +
    '                </select>  \n' +
    '                <p ng-show="eventForm.event_type_id.$error.required && ( vm.formSubmitted || eventForm.event_type_id.$touched)" class="help-block">Event type is required.</p>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '\n' +
    '            <div class="form-group" ng-class="{ \'has-error\': eventForm.organizer_id.$invalid && ( vm.formSubmitted || eventForm.organizer_id.$touched) }">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Organizer</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <select ng-options="t.id as t.name for t in vm.organizers" ng-model="vm.data.organizer_id" class="form-control" name="organizer_id" required>\n' +
    '                  <!--<option value="">-- Select Event Type --</option>-->\n' +
    '                </select>  \n' +
    '                <p ng-show="eventForm.organizer_id.$error.required && ( vm.formSubmitted || eventForm.organizer_id.$touched)" class="help-block">Organizer is required.</p>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            \n' +
    '            <div class="form-group">\n' +
    ...
    '              <div class="col-sm-10">\n' +
    '                <input type="number" class="form-control" ng-model="vm.data.price" name="price" placeholder="Name">\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group" ng-class="{ \'has-error\': eventForm.event_venue.$invalid && ( vm.formSubmitted || eventForm.event_venue.$touched) }">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Event Venue</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.event_venue" name="event_venue" placeholder="Event Venue" required>\n' +
    '                <p ng-show="eventForm.event_venue.$error.required && ( vm.formSubmitted || eventForm.event_venue.$touched)" class="help-block">Event venue is required.</p>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group" ng-class="{ \'has-error\': eventForm.event_address.$invalid && ( vm.formSubmitted || eventForm.event_address.$touched) }">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Event Address</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.event_address" name="event_address" placeholder="Event Address" required>\n' +
    '                <p ng-show="eventForm.event_address.$error.required && ( vm.formSubmitted || eventForm.event_address.$touched)" class="help-block">Event address is required.</p>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Province</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <select ng-options="t.province_id as t.province_name for t in vm.provinces" ng-model="vm.data.province_id" data-ng-change="vm.onProvinceChange(vm.data.province_id)" class="form-control" name="province_id">\n' +
    '                </select>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    ...
    '              <div class="col-sm-10">\n' +
    '                <select ng-options="t.city_id as t.city_name for t in vm.filteredCities" ng-model="vm.data.city_id" class="form-control" name="city_id" required>\n' +
    '                </select>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    ...
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.contact_person_name" name="contact_person_name" placeholder="Contact person">\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Telp</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.contact_person_number" name="contact_person_number" placeholder="Telp">\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Is Published?</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="checkbox" style="margin-top:10px;" ng-model="vm.data.is_published" name="is_published">\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Picture</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <button type="file" ngf-select="vm.uploadFile($file, $invalidFiles)"\n' +
    '                    accept="image/*">\n' +
    '                Select File</button>\n' +
    '                <img style="width:100px; height:100px;" ng-src={{vm.data.picture_url}} />\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Description</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <text-angular ng-model="vm.data.description" name="description"></text-angular>\n' +
    '                <!--<p ng-show="eventTypeForm.description.$error.required && ( vm.formSubmitted || eventTypeForm.description.$touched)" class="help-block">Description is required.</p>-->\n' +
    '              </div>\n' +
    '            </div>\n' +
    '          </div>\n' +
    ...
    '          <div class="box-body">\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-4 control-label">Is Continous?</label>\n' +
    '              <div class="col-sm-8">\n' +
    '                <input type="checkbox" style="margin-top:10px;" ng-model="vm.data.is_continuous" name="is_continuous">\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group" ng-class="{ \'has-error\': eventForm.start_date.$invalid && ( vm.formSubmitted || eventForm.start_date.$touched) }">\n' +
    '              <label for="inputEmail3" class="col-sm-4 control-label">Start Date</label>\n' +
    '              <div class="col-sm-8">\n' +
    '                <p class="input-group">\n' +
    '                  <input type="text" class="form-control" uib-datepicker-popup="dd-MMMM-yyyy" ng-model="vm.data.start_date" is-open="vm.sd_datepicker.opened" close-text="Close" name="start_date" neutral-timezone required />\n' +
    '                  <span class="input-group-btn">\n' +
    '                    <button type="button" class="btn btn-default" ng-click="vm.sd_datepicker.opened=true"><i class="glyphicon glyphicon-calendar"></i></button>\n' +
    '                  </span>\n' +
    '                  <p ng-show="eventForm.start_date.$error.required && ( vm.formSubmitted || eventForm.start_date.$touched)" class="help-block" style="color:red;">Start date is required.</p>\n' +
    '                </p>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group" ng-if="vm.data.is_continuous">\n' +
    '              <label for="inputEmail3" class="col-sm-4 control-label">End Date</label>\n' +
    '              <div class="col-sm-8">\n' +
    '                <p class="input-group">\n' +
    '                  <input type="text" class="form-control" uib-datepicker-popup="dd-MMMM-yyyy" ng-model="vm.data.end_date" is-open="vm.ed_datepicker.opened"  close-text="Close" neutral-timezone />\n' +
    '                  <span class="input-group-btn">\n' +
    '                    <button type="button" class="btn btn-default" ng-click="vm.ed_datepicker.opened=true"><i class="glyphicon glyphicon-calendar"></i></button>\n' +
    '                  </span>\n' +
    '                </p>\n' +
    '              </div>\n' +
    '            </div>\n' +
    ...
    '              <div class="col-sm-8">\n' +
    '                <p class="input-group">\n' +
    '                  <button class="btn btn-warning btn-sm" ng-click="vm.onClearDate()">Clear Date</button>\n' +
    '                </p>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <!--<div class="form-group" ng-class="{ \'has-error\': eventForm.start_time.$invalid && ( vm.formSubmitted || eventForm.start_time.$touched) }">\n' +
    '              <label for="inputEmail3" class="col-sm-4 control-label">Start Time</label>\n' +
    '              <div class="col-sm-8">\n' +
    '                <div uib-timepicker ng-model="vm.data.start_time" ng-change="vm.st_changed()" show-meridian="false" name="start_time" neutral-timezone required></div>\n' +
    '                <p ng-show="eventForm.start_time.$error.required && ( vm.formSubmitted || eventForm.start_time.$touched)" class="help-block" style="color:red;">Start time is required.</p>\n' +
    '              </div>\n' +
    '            </div>            \n' +
    '            <div class="form-group" ng-class="{ \'has-error\': eventForm.end_time.$invalid && ( vm.formSubmitted || eventForm.end_time.$touched) }">\n' +
    '              <label for="inputEmail3" class="col-sm-4 control-label">End Time</label>\n' +
    '              <div class="col-sm-8">\n' +
    '                <div uib-timepicker ng-model="vm.data.end_time" ng-change="vm.et_changed()" show-meridian="false" neutral-timezone name="end_time" required></div>\n' +
    '                <p ng-show="eventForm.end_time.$error.required && ( vm.formSubmitted || eventForm.end_time.$touched)" class="help-block" style="color:red;">End time is required.</p>\n' +
    '              </div>\n' +
    '            </div>-->\n' +
    '          </div>\n' +
    '        \n' +
    ...
    '        </div>\n' +
    '          <div class="box-body">\n' +
    '            <div class="col-md-12" ng-repeat="cat in vm.categories">\n' +
    '              <input type="checkbox" ng-model="cat.is_selected" /><span style="margin-top:-5px;">&nbsp;{{cat.name}}</span>\n' +
    '            </div>\n' +
    '          </div>\n' +
    '        \n' +
    '      </div>\n' +
    ...
    '          <div class="box-footer">\n' +
    '            <a ui-sref="app.eventlist" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</a>\n' +
    '            <button type="submit" class="btn btn-primary pull-right">Save</button>\n' +
    '          </div>\n' +
    '    </div>\n' +
    '  </div>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/event/event-list/event-list.component.html',
    '<section class="content-header">\n' +
    ...
    '          <div class="box-tools pull-right">\n' +
    '            <a ui-sref="app.eventform" class="btn btn-block btn-primary btn-sm"><i class="fa fa-plus"></i> Add New</a>\n' +
    '          </div>\n' +
    '        </div>\n' +
    '        <div class="box-body">\n' +
    '          <table datatable="" width="100%" class="table table-striped table-bordered" ng-if="vm.displayTable" dt-options="vm.dtOptions" dt-columns="vm.dtColumns"></table>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/event-type/event-type-form/event-type-form.component.html',
    '<section class="content-header">\n' +
    '  <h1>Event Type <small></small></h1>\n' +
    '  <ol class="breadcrumb">\n' +
    '    <li><a ui-sref="app.landing"><i class="fa fa-dashboard"></i> Home</a></li>\n' +
    '    <li><a ui-sref="app.userlist">Event Type Lists</a></li>\n' +
    '    <li class="active">Event Type Form</li>\n' +
    '  </ol>\n' +
    '</section>\n' +
    '<section class="content">\n' +
    '  <div class="row">\n' +
    ...
    '      <div class="box box-primary">\n' +
    '        <div class="box-header with-border">\n' +
    '          <h3 class="box-title">Event Type Form</h3>\n' +
    '        </div>\n' +
    '        <form class="form-horizontal" name="eventTypeForm" ng-submit="vm.save(eventTypeForm.$valid)" novalidate>\n' +
    '          <div class="box-body">\n' +
    '            <div ng-if="vm.alerts" class="alert alert-{{alert.type}}" ng-repeat="alert in vm.alerts">\n' +
    ...
    '          </div>\n' +
    '          <div class="box-footer">\n' +
    '            <a ui-sref="app.eventtypelist" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</a>\n' +
    '            <button type="submit" class="btn btn-primary pull-right">Save</button>\n' +
    '          </div>\n' +
    '        </form>\n' +
    '      </div>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/event-type/event-type-list/event-type-list.component.html',
    '<section class="content-header">\n' +
    '  <h1>Event Type <small></small></h1>\n' +
    '  <ol class="breadcrumb">\n' +
    '    <li><a ui-sref="app.landing"><i class="fa fa-dashboard"></i> Home</a></li>\n' +
    '    <li class="active">Event Type Lists</li>\n' +
    '  </ol>\n' +
    '</section>\n' +
    '<section class="content">\n' +
    '  <div class="row">\n' +
    ...
    '          <div class="box-tools pull-right">\n' +
    '            <a ui-sref="app.eventtypeform" class="btn btn-block btn-primary btn-sm"><i class="fa fa-plus"></i> Add New</a>\n' +
    '          </div>\n' +
    '        </div>\n' +
    '        <div class="box-body">\n' +
    '          <table datatable="" width="100%" class="table table-striped table-bordered" ng-if="vm.displayTable" dt-options="vm.dtOptions" dt-columns="vm.dtColumns"></table>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/organizer/organizer-form/organizer-form.component.html',
    '<section class="content-header">\n' +
    '  <h1>Organizer <small></small></h1>\n' +
    '  <ol class="breadcrumb">\n' +
    '    <li><a ui-sref="app.landing"><i class="fa fa-dashboard"></i> Home</a></li>\n' +
    '    <li><a ui-sref="app.userlist">Organizer Form</a></li>\n' +
    '    <li class="active">Organizer Form</li>\n' +
    '  </ol>\n' +
    '</section>\n' +
    '<section class="content">\n' +
    '  <div class="row">\n' +
    ...
    '      <div class="box box-primary">\n' +
    '        <div class="box-header with-border">\n' +
    '          <h3 class="box-title">Organizer Form</h3>\n' +
    '        </div>\n' +
    '        <form class="form-horizontal" name="eventTypeForm" ng-submit="vm.save(eventTypeForm.$valid)" novalidate>\n' +
    '          <div class="box-body">\n' +
    '            <div ng-if="vm.alerts" class="alert alert-{{alert.type}}" ng-repeat="alert in vm.alerts">\n' +
    ...
    '              <label for="inputEmail3" class="col-sm-2 control-label">Description</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.description" name="description" placeholder="Description">\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Address</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.address" name="address" placeholder="Address">\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">City</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.city" name="city" placeholder="City">\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Province</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.province" name="province" placeholder="Province">\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Telp 1</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.telp_1" name="telp_1" placeholder="Telp 1">\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Telp 2</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.telp_2" name="telp_2" placeholder="Telp 2">\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Website</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.website" name="website" placeholder="Website">\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Facebook</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.fb" name="fb" placeholder="Facebook">\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Twitter</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.twitter" name="twitter" placeholder="Twitter">\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Line</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.line" name="line" placeholder="Line">\n' +
    '              </div>\n' +
    '            </div>\n' +
    '          </div>\n' +
    '          <div class="box-footer">\n' +
    '            <a ui-sref="app.organizerlist" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</a>\n' +
    '            <button type="submit" class="btn btn-primary pull-right">Save</button>\n' +
    '          </div>\n' +
    '        </form>\n' +
    '      </div>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/product/product-form/product-form.component.html',
    ...
    '        </div>\n' +
    '        <div class="panel-body">\n' +
    '          <form class="form-horizontal" name="productForm" ng-submit="vm.save(productForm.$valid)" novalidate>\n' +
    '            <div class="box-body">\n' +
    '              <div ng-if="vm.alerts" class="alert alert-{{alert.type}}" ng-repeat="alert in vm.alerts">\n' +
    '                <h4>{{alert.title}}</h4>\n' +
    '                <p>{{alert.msg}}</p>\n' +
    '              </div>\n' +
    '              <div class="form-group" ng-class="{ \'has-error\': productForm.code.$invalid && ( vm.formSubmitted || productForm.code.$touched) }">\n' +
    '                <label for="inputEmail3" class="col-sm-2 control-label">Kode Barang</label>\n' +
    '                <div class="col-sm-10">\n' +
    '                  <input type="text" class="form-control" ng-model="vm.data.code" name="name" placeholder="Name" required>\n' +
    '                  <p ng-show="productForm.code.$error.required && ( vm.formSubmitted || productForm.code.$touched)" class="help-block">Kode wajid diisi.</p>\n' +
    '                </div>\n' +
    '              </div>\n' +
    '              <div class="form-group" ng-class="{ \'has-error\': productForm.description.$invalid && ( vm.formSubmitted || productForm.description.$touched) }">\n' +
    '                <label for="inputEmail3" class="col-sm-2 control-label">Deskripsi Barang</label>\n' +
    '                <div class="col-sm-10">\n' +
    '                  <input type="text" class="form-control" ng-model="vm.data.description" name="description" placeholder="Description" required>\n' +
    '                  <p ng-show="productForm.description.$error.required && ( vm.formSubmitted || productForm.description.$touched)" class="help-block">Deskripsi wajid diisi.</p>\n' +
    '                </div>\n' +
    '              </div>\n' +
    '              <div class="form-group" ng-class="{ \'has-error\': productForm.organizer_id.$invalid && ( vm.formSubmitted || productForm.organizer_id.$touched) }">\n' +
    '                <label for="inputEmail3" class="col-sm-2 control-label">Tipe Barang</label>\n' +
    '                <div class="col-sm-10">\n' +
    '                  <select ng-options="t as t for t in vm.types" ng-model="vm.data.type" class="form-control" name="type" required>\n' +
    '                  <option value="">-- Pilih Tipe Barang --</option>\n' +
    '                </select>\n' +
    '                  <p ng-show="productForm.type.$error.required && (vm.formSubmitted || productForm.type.$touched)" class="help-block">Tipe wajid diisi.</p>\n' +
    '                </div>\n' +
    '              </div>\n' +
    '\n' +
    '            </div>\n' +
    '            <div class="box-footer">\n' +
    '              <a ui-sref="app.master-product" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</a>\n' +
    '              <button type="submit" class="btn btn-primary pull-right">Save</button>\n' +
    '            </div>\n' +
    '          </form>\n' +
    '        </div>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/organizer/organizer-list/organizer-list.component.html',
    '<section class="content-header">\n' +
    '  <h1>Organizer <small></small></h1>\n' +
    '  <ol class="breadcrumb">\n' +
    '    <li><a ui-sref="app.landing"><i class="fa fa-dashboard"></i> Home</a></li>\n' +
    ...
    '          <div class="box-tools pull-right">\n' +
    '            <a ui-sref="app.organizerform" class="btn btn-block btn-primary btn-sm"><i class="fa fa-plus"></i> Add New</a>\n' +
    '          </div>\n' +
    '        </div>\n' +
    '        <div class="box-body">\n' +
    '          <table datatable="" width="100%" class="table table-striped table-bordered" ng-if="vm.displayTable" dt-options="vm.dtOptions" dt-columns="vm.dtColumns"></table>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/product/product-list/product-list.component.html',
    ...
    '          <div class="row">\n' +
    '            <div class="col-lg-6">\n' +
    '              <h4>Daftar Semua Product</h4>\n' +
    '            </div>\n' +
    '            <div class="col-lg-6">\n' +
    '              <a ui-sref="app.master-product-form" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i> Tambah Product Baru</a>\n' +
    '            </div>\n' +
    '          </div>\n' +
    '        </div>\n' +
    '        <div class="panel-body" style="margin-top:25px;">\n' +
    '          <table datatable="" width="100%" class="table table-striped table-bordered" ng-if="vm.displayTable" dt-options="vm.dtOptions"\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/scholarship/scholarship-form/scholarship-form.component.html',
    '<section class="content-header">\n' +
    '  <h1>Scholarship Form <small></small></h1>\n' +
    '  <ol class="breadcrumb">\n' +
    '    <li><a ui-sref="app.landing"><i class="fa fa-dashboard"></i> Home</a></li>\n' +
    '    <li><a ui-sref="app.userlist">Scholarship Lists</a></li>\n' +
    ...
    '              <p>{{alert.msg}}</p>\n' +
    '            </div>\n' +
    '            <div class="form-group" ng-class="{ \'has-error\': eventTypeForm.title.$invalid && ( vm.formSubmitted || eventTypeForm.title.$touched) }">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Title</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.title" name="title" placeholder="Title" required>\n' +
    '                <p ng-show="eventTypeForm.title.$error.required && ( vm.formSubmitted || eventTypeForm.title.$touched)" class="help-block">Title is required.</p>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group" ng-class="{ \'has-error\': eventTypeForm.description.$invalid && ( vm.formSubmitted || eventTypeForm.description.$touched) }">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Description</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <textarea type="text" class="form-control" ng-model="vm.data.description" name="description" placeholder="description"\n' +
    '                  required></textarea>\n' +
    '                <p ng-show="eventTypeForm.description.$error.required && ( vm.formSubmitted || eventTypeForm.description.$touched)"\n' +
    '                  class="help-block">description is required.</p>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group" ng-class="{ \'has-error\': eventTypeForm.organizer.$invalid && ( vm.formSubmitted || eventTypeForm.organizer.$touched) }">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Organizer</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.organizer" name="organizer" placeholder="organizer" required>\n' +
    '                <p ng-show="eventTypeForm.company.$error.required && ( vm.formSubmitted || eventTypeForm.company.$touched)" class="help-block">Organizer is required.</p>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Organizer Description</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <textarea ng-model="vm.data.organizer_description" class="form-control"></textarea>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Province</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <select ng-options="t.province_id as t.province_name for t in vm.provinces" style="width: 300px;" ng-model="vm.data.province_id" data-ng-change="vm.onProvinceChange(vm.data.province_id)" class="form-control" name="province_id">\n' +
    '                </select>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">City</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <select ng-options="t.city_id as t.city_name for t in vm.filteredCities" style="width: 300px;" ng-model="vm.data.city_id" class="form-control" name="city_id" required>\n' +
    '                </select>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Application Deadline</label>\n' +
    '              <div class="col-sm-6">\n' +
    '                <p class="input-group">\n' +
    '                  <input type="text" class="form-control" uib-datepicker-popup="dd-MMMM-yyyy" ng-model="vm.data.deadline" is-open="vm.datepicker.opened"\n' +
    '                    close-text="Close" name="due_date" neutral-timezone />\n' +
    '                  <span class="input-group-btn">\n' +
    '                    <button type="button" class="btn btn-default" ng-click="vm.datepicker.opened=true"><i class="glyphicon glyphicon-calendar"></i></button>\n' +
    '                  </span>\n' +
    '\n' +
    '                </p>\n' +
    '                <button class="btn btn-sm btn-warning" ng-click="vm.onClearDate()" type="button">Clear Date</button>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Is Published?</label>\n' +
    ...
    '          </div>\n' +
    '          <div class="box-footer">\n' +
    '            <a ui-sref="app.vacancylist" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</a>\n' +
    '            <button type="submit" class="btn btn-primary pull-right">Save</button>\n' +
    '          </div>\n' +
    '        </form>\n' +
    '      </div>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/scholarship/scholarship-list/scholarship-list.component.html',
    '<section class="content-header">\n' +
    '  <h1>Scholarship <small></small></h1>\n' +
    '  <ol class="breadcrumb">\n' +
    '    <li><a ui-sref="app.landing"><i class="fa fa-dashboard"></i> Home</a></li>\n' +
    ...
    '          <div class="box-tools pull-right">\n' +
    '            <a ui-sref="app.scholarshipform" class="btn btn-block btn-primary btn-sm"><i class="fa fa-plus"></i> Add New</a>\n' +
    '          </div>\n' +
    '        </div>\n' +
    '        <div class="box-body">\n' +
    '          <table datatable="" width="100%" class="table table-striped table-bordered" ng-if="vm.displayTable" dt-options="vm.dtOptions" dt-columns="vm.dtColumns"></table>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/vacancy/vacancy-form/vacancy-form.component.html',
    '<section class="content-header">\n' +
    '  <h1>Vacancy Form <small></small></h1>\n' +
    '  <ol class="breadcrumb">\n' +
    '    <li><a ui-sref="app.landing"><i class="fa fa-dashboard"></i> Home</a></li>\n' +
    '    <li><a ui-sref="app.userlist">Vacancy Lists</a></li>\n' +
    '    <li class="active">Vacancy Form</li>\n' +
    '  </ol>\n' +
    '</section>\n' +
    '<section class="content">\n' +
    '  <div class="row">\n' +
    ...
    '      <div class="box box-primary">\n' +
    '        <div class="box-header with-border">\n' +
    '          <h3 class="box-title">Volunteer / Internship</h3>\n' +
    '        </div>\n' +
    '        <form class="form-horizontal" name="eventTypeForm" ng-submit="vm.save(eventTypeForm.$valid)" novalidate>\n' +
    '          <div class="box-body">\n' +
    '            <div ng-if="vm.alerts" class="alert alert-{{alert.type}}" ng-repeat="alert in vm.alerts">\n' +
    ...
    '              <p>{{alert.msg}}</p>\n' +
    '            </div>\n' +
    '            <div class="form-group" ng-class="{ \'has-error\': eventForm.vacancy_type_id.$invalid && ( vm.formSubmitted || eventForm.vacancy_type_id.$touched) }">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Type</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <select ng-options="t.id as t.name for t in vm.vacancy_types" ng-model="vm.data.vacancy_type_id" class="form-control" name="vacancy_type_id"\n' +
    '                  required>\n' +
    '                  <!--<option value="">-- Select Event Type --</option>-->\n' +
    '                </select>\n' +
    '                <p ng-show="eventForm.vacancy_type_id.$error.required && ( vm.formSubmitted || eventForm.vacancy_type_id.$touched)" class="help-block">Vacancy type is required.</p>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group" ng-class="{ \'has-error\': eventTypeForm.title.$invalid && ( vm.formSubmitted || eventTypeForm.title.$touched) }">\n' +
    ...
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group" ng-class="{ \'has-error\': eventTypeForm.job_description.$invalid && ( vm.formSubmitted || eventTypeForm.job_description.$touched) }">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Job Description</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <textarea type="text" class="form-control" ng-model="vm.data.job_description" name="job_description" placeholder="job_description"\n' +
    '                  required></textarea>\n' +
    '                <p ng-show="eventTypeForm.job_description.$error.required && ( vm.formSubmitted || eventTypeForm.job_description.$touched)"\n' +
    '                  class="help-block">job_description is required.</p>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group" ng-class="{ \'has-error\': eventTypeForm.company.$invalid && ( vm.formSubmitted || eventTypeForm.company.$touched) }">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Company</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <input type="text" class="form-control" ng-model="vm.data.company_name" name="company" placeholder="company" required>\n' +
    '                <p ng-show="eventTypeForm.company.$error.required && ( vm.formSubmitted || eventTypeForm.company.$touched)" class="help-block">company is required.</p>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Company Description</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <textarea ng-model="vm.data.company_description" class="form-control"></textarea>\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <!--<div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Caption</label>\n' +
    ...
    '            </div>-->\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Salary Range</label>\n' +
    '              <div class="col-sm-8" style="display: inline-flex;">\n' +
    '                <input type="number" ng-model="vm.data.salary_from" class="form-control" />\n' +
    '                <span style="margin-left: 10px; margin-right: 10px; margin-top: -10px;">&nbsp; to &nbsp;</span>\n' +
    '                <input type="number" ng-model="vm.data.salary_to" class="form-control" />\n' +
    '              </div>\n' +
    '            </div>\n' +
    '            <div class="form-group">\n' +
    '              <label for="inputEmail3" class="col-sm-2 control-label">Province</label>\n' +
    ...
    '              <div class="col-sm-6">\n' +
    '                <p class="input-group">\n' +
    '                  <input type="text" class="form-control" uib-datepicker-popup="dd-MMMM-yyyy" ng-model="vm.data.due_date" is-open="vm.datepicker.opened"\n' +
    '                    close-text="Close" name="due_date" neutral-timezone />\n' +
    '                  <span class="input-group-btn">\n' +
    '                    <button type="button" class="btn btn-default" ng-click="vm.datepicker.opened=true"><i class="glyphicon glyphicon-calendar"></i></button>\n' +
    '                  </span>\n' +
    ...
    '              <label for="inputEmail3" class="col-sm-2 control-label">Description</label>\n' +
    '              <div class="col-sm-10">\n' +
    '                <text-angular ng-model="vm.data.description" name="description" required></text-angular>\n' +
    '                <p ng-show="eventTypeForm.description.$error.required && ( vm.formSubmitted || eventTypeForm.description.$touched)" class="help-block">Description is required.</p>\n' +
    '              </div>\n' +
    '            </div>-->\n' +
    '          </div>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/vacancy-type/vacancy-type-form/vacancy-type-form.component.html',
    '<section class="content-header">\n' +
    '  <h1>Vacancy Type Form <small></small></h1>\n' +
    '  <ol class="breadcrumb">\n' +
    '    <li><a ui-sref="app.landing"><i class="fa fa-dashboard"></i> Home</a></li>\n' +
    '    <li><a ui-sref="app.userlist">Vacancy Type Lists</a></li>\n' +
    '    <li class="active">Vacancy Type Form</li>\n' +
    '  </ol>\n' +
    '</section>\n' +
    '<section class="content">\n' +
    '  <div class="row">\n' +
    ...
    '      <div class="box box-primary">\n' +
    '        <div class="box-header with-border">\n' +
    '          <h3 class="box-title">Vacancy Type Form</h3>\n' +
    '        </div>\n' +
    '        <form class="form-horizontal" name="eventTypeForm" ng-submit="vm.save(eventTypeForm.$valid)" novalidate>\n' +
    '          <div class="box-body">\n' +
    '            <div ng-if="vm.alerts" class="alert alert-{{alert.type}}" ng-repeat="alert in vm.alerts">\n' +
    ...
    '          </div>\n' +
    '          <div class="box-footer">\n' +
    '            <a ui-sref="app.vacancytypelist" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</a>\n' +
    '            <button type="submit" class="btn btn-primary pull-right">Save</button>\n' +
    '          </div>\n' +
    '        </form>\n' +
    '      </div>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/vacancy/vacancy-list/vacancy-list.component.html',
    '<section class="content-header">\n' +
    '  <h1>Vacancy <small></small></h1>\n' +
    '  <ol class="breadcrumb">\n' +
    '    <li><a ui-sref="app.landing"><i class="fa fa-dashboard"></i> Home</a></li>\n' +
    ...
    '          <div class="box-tools pull-right">\n' +
    '            <a ui-sref="app.vacancyform" class="btn btn-block btn-primary btn-sm"><i class="fa fa-plus"></i> Add New</a>\n' +
    '          </div>\n' +
    '        </div>\n' +
    '        <div class="box-body">\n' +
    '          <table datatable="" width="100%" class="table table-striped table-bordered" ng-if="vm.displayTable" dt-options="vm.dtOptions" dt-columns="vm.dtColumns"></table>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('./views/app/components/vacancy-type/vacancy-type-list/vacancy-type-list.component.html',
    '<section class="content-header">\n' +
    '  <h1>Vacancy Type <small></small></h1>\n' +
    '  <ol class="breadcrumb">\n' +
    '    <li><a ui-sref="app.landing"><i class="fa fa-dashboard"></i> Home</a></li>\n' +
    '    <li class="active">Vacancy Type List</li>\n' +
    '  </ol>\n' +
    '</section>\n' +
    '<section class="content">\n' +
    '  <div class="row">\n' +
    ...
    '      <div class="box box-info">\n' +
    '        <div class="box-header with-border">\n' +
    '          <h3 class="box-title">Vacancy Type List</h3>\n' +
    '          <div class="box-tools pull-right">\n' +
    '            <a ui-sref="app.vacancytypeform" class="btn btn-block btn-primary btn-sm"><i class="fa fa-plus"></i> Add New</a>\n' +
    '          </div>\n' +
    '        </div>\n' +
    '        <div class="box-body">\n' +
    '          <table datatable="" width="100%" class="table table-striped table-bordered" ng-if="vm.displayTable" dt-options="vm.dtOptions" dt-columns="vm.dtColumns"></table>\n' +
